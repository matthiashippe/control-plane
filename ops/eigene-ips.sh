...
#
# What it cost: `ops/tiefe.sh` reported "1 page load from outside, control pixel fetched" on the
...
# to ops/eigene-ips.txt with the date it was first seen, and the file is in the repository because
...
#
#   source ops/eigene-ips.sh; OWN=$(eigene_ips)
